...
| [#898](https://github.com/adinapoli/rusholme/issues/898) | Thread superclass dictionaries into class default-method bodies (unblocks `asinh`/`acosh`/`atanh`) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#889](https://github.com/adinapoli/rusholme/issues/889) | :yellow_circle: |
| [#901](https://github.com/adinapoli/rusholme/issues/901) | Backend: case-block cache re-entry uses non-dominating pre-forced scrutinee — silent wrong code for multi-equation constructor patterns | — | :yellow_circle: |
