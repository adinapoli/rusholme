...
| [#951](https://github.com/adinapoli/rusholme/issues/951) | `Eq` and `Ord` have no default methods — every instance must define all of them (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#948](https://github.com/adinapoli/rusholme/issues/948) | :green_circle: |
| [#952](https://github.com/adinapoli/rusholme/issues/952) | No `Eq`/`Ord` instances for lists, `Maybe`, `Either`, `Ordering` or tuples (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#951](https://github.com/adinapoli/rusholme/issues/951), [#948](https://github.com/adinapoli/rusholme/issues/948) | :green_circle: |
