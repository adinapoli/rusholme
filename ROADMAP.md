...
| [#675](https://github.com/adinapoli/rusholme/issues/675) | Package store: use `defaultPath` as the canonical store root | [#650](https://github.com/adinapoli/rusholme/issues/650) | :white_circle: |
