...
| [#898](https://github.com/adinapoli/rusholme/issues/898) | Thread superclass dictionaries into class default-method bodies (unblocks `asinh`/`acosh`/`atanh`) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#889](https://github.com/adinapoli/rusholme/issues/889) | :white_circle: |
