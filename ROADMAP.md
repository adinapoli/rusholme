...
| [#736](https://github.com/adinapoli/rusholme/issues/736) | desugar: LeftSection / RightSection / Negate still emit placeholder Vars | [#149](https://github.com/adinapoli/rusholme/issues/149) | :green_circle: |
...
| [#747](https://github.com/adinapoli/rusholme/issues/747) | Multi-binding `let` (incl. let-qualifier) miscompiles/segfaults | [#149](https://github.com/adinapoli/rusholme/issues/149), [#347](https://github.com/adinapoli/rusholme/issues/347) | :green_circle: |
| [#753](https://github.com/adinapoli/rusholme/issues/753) | Rec lowering: backpatch chain runs in source order, not dependency order | [#347](https://github.com/adinapoli/rusholme/issues/347), [#747](https://github.com/adinapoli/rusholme/issues/747) | :green_circle: |
...
| [#855](https://github.com/adinapoli/rusholme/issues/855) | Desugar record construction into positional constructor application (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | — | :green_circle: |
| [#857](https://github.com/adinapoli/rusholme/issues/857) | Desugar record patterns into positional constructor patterns (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#855](https://github.com/adinapoli/rusholme/issues/855) | :green_circle: |
...
| [#880](https://github.com/adinapoli/rusholme/issues/880) | Add `instance Num Double` and floating-point arithmetic primops (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#879](https://github.com/adinapoli/rusholme/issues/879) | :green_circle: |
| [#881](https://github.com/adinapoli/rusholme/issues/881) | Instance dictionary CAFs cannot forward-reference later-declared instances (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | — | :green_circle: |
| [#883](https://github.com/adinapoli/rusholme/issues/883) | Add `instance Show Double` (render floating-point values) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#880](https://github.com/adinapoli/rusholme/issues/880) | :green_circle: |
| [#884](https://github.com/adinapoli/rusholme/issues/884) | Reconcile boxed-value vs unboxed-f64-field representation for `Double` in ADT fields (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#880](https://github.com/adinapoli/rusholme/issues/880) | :green_circle: |
| [#887](https://github.com/adinapoli/rusholme/issues/887) | Add `Fractional` class and `instance Fractional Double` (floating division) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#880](https://github.com/adinapoli/rusholme/issues/880) | :green_circle: |
| [#889](https://github.com/adinapoli/rusholme/issues/889) | Consume superclass contexts: entailment, dictionary extraction, and H2010 class hierarchy in GHC.Base (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#887](https://github.com/adinapoli/rusholme/issues/887) | :green_circle: |
| [#891](https://github.com/adinapoli/rusholme/issues/891) | Do-block let-bound ADT value panics the desugarer: 'Variable not found in type definitions' (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | — | :green_circle: |
| [#895](https://github.com/adinapoli/rusholme/issues/895) | Add `Floating` class and `instance Floating Double` (transcendental primops via libm) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#887](https://github.com/adinapoli/rusholme/issues/887) | :green_circle: |
...
| [#925](https://github.com/adinapoli/rusholme/issues/925) | Higher-kinded user class: showing a method result fails to link (`dict$Show_0`) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | — | :green_circle: |
| [#934](https://github.com/adinapoli/rusholme/issues/934) | CoreType cannot represent type-variable application (needs AppTy for higher-kinded classes) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#925](https://github.com/adinapoli/rusholme/issues/925) | :green_circle: |
| [#926](https://github.com/adinapoli/rusholme/issues/926) | Expose the Functor/Applicative/Monad hierarchy — `>>=` not in scope, `do` only works for IO (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#889](https://github.com/adinapoli/rusholme/issues/889), [#934](https://github.com/adinapoli/rusholme/issues/934) | :green_circle: |
| [#938](https://github.com/adinapoli/rusholme/issues/938) | Nested do-blocks of different monads share one monad metavariable (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#926](https://github.com/adinapoli/rusholme/issues/926) | :white_circle: |
| [#939](https://github.com/adinapoli/rusholme/issues/939) | IO action values are memoised — running the same action twice performs its effect once (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#926](https://github.com/adinapoli/rusholme/issues/926) | :green_circle: |
| [#940](https://github.com/adinapoli/rusholme/issues/940) | `pure` through a dictionary parameter drops its argument (higher-kinded class from another module) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#926](https://github.com/adinapoli/rusholme/issues/926) | :white_circle: |
| [#941](https://github.com/adinapoli/rusholme/issues/941) | do-notation at IO bypasses `instance Monad IO` in favour of structural GRIN sequencing (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#939](https://github.com/adinapoli/rusholme/issues/939) | :white_circle: |
| [#943](https://github.com/adinapoli/rusholme/issues/943) | Do-block tail action values are never performed (`main = do { act }` runs nothing) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#939](https://github.com/adinapoli/rusholme/issues/939) | :white_circle: |
...
| [#928](https://github.com/adinapoli/rusholme/issues/928) | Prelude/`Data.List` gaps: `maximum`, `minimum`, `sort`, `sortBy`, `nub`, `foldl'` (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | — | :green_circle: |
| [#929](https://github.com/adinapoli/rusholme/issues/929) | `show` on a `String` renders a character list instead of a quoted string (`Show` needs `showList`) (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#948](https://github.com/adinapoli/rusholme/issues/948) | :green_circle: |
| [#930](https://github.com/adinapoli/rusholme/issues/930) | `Show` instances for tuple widths 6..15 (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#927](https://github.com/adinapoli/rusholme/issues/927) | :green_circle: |
...
| [#951](https://github.com/adinapoli/rusholme/issues/951) | `Eq` and `Ord` have no default methods — every instance must define all of them (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#948](https://github.com/adinapoli/rusholme/issues/948) | :yellow_circle: |
| [#952](https://github.com/adinapoli/rusholme/issues/952) | No `Eq`/`Ord` instances for lists, `Maybe`, `Either`, `Ordering` or tuples (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#951](https://github.com/adinapoli/rusholme/issues/951), [#948](https://github.com/adinapoli/rusholme/issues/948) | :yellow_circle: |
...
| [#962](https://github.com/adinapoli/rusholme/issues/962) | Instances are identified by line/column only, so instances in different modules collide (epic [#845](https://github.com/adinapoli/rusholme/issues/845)) | [#889](https://github.com/adinapoli/rusholme/issues/889) | :yellow_circle: |
...
| [#537](https://github.com/adinapoli/rusholme/issues/537) | Respect `NoImplicitPrelude` in renamer and typechecker builtin initialization | [#527](https://github.com/adinapoli/rusholme/issues/527) | :green_circle: |
