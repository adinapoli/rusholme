...
/// Build a partial-application tag for a function thunk that is
/// missing `missing` arguments. Used by constructor wrappers and the
/// under-application emission path. Kept as a free helper after the
/// dead eval/apply generators were removed in #520.
